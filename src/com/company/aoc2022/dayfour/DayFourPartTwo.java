...
public class DayFourPartTwo {
    ...
    public static void run(){
        ...
        System.out.println("Day 4 - Part 2: " + sum);
    }

    private static boolean checkInclusion(final List<List<Integer>> list) {
        return ((list.get(1).get(0) >= list.get(0).get(0) && list.get(1).get(0) <= list.get(0).get(1)) ||
                (list.get(1).get(1) >= list.get(0).get(0) && list.get(1).get(1) <= list.get(0).get(1))) ||
                ((list.get(0).get(0) >= list.get(1).get(0) && list.get(0).get(0) <= list.get(1).get(1)) ||
                        (list.get(0).get(1) >= list.get(1).get(0) && list.get(0).get(1) <= list.get(1).get(1))) ;
    }
